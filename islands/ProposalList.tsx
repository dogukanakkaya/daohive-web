    ...
    <main>
      <div class="flex gap-4 px-6 mb-8">
        <div className="relative flex-grow">
          ...
          <input
            ...
            name="search"
            class="w-full pl-10 pr-4 py-3 bg-gray-800 rounded-lg focus:outline-none hover:bg-[#14253d]"
            type="search"
      ...
      <div class="grid md:grid-cols-3 gap-8 px-6">
        {proposals.map((proposal) => (
          <div class="dark:bg-[#14253d] p-6 rounded-xl space-y-4 transition-transform hover:scale-[1.025]">
            <div>
              <img
            ...
            <div class="flex gap-4">
              ...
              <span class="flex items-center justify-center w-1/3 h-16 bg-gray-900 hover:bg-opacity-50 rounded-xl cursor-pointer">
                3 days left <i class="bi bi-clock-history ml-2"></i>
              </span>
              <span class="flex items-center justify-center w-1/3 h-16 bg-indigo-500 hover:bg-indigo-600 bg-opacity-70 rounded-xl cursor-pointer">Contract</span>
            </div>
            <Button class="py-3">
              Show more <i class="bi bi-box-arrow-in-up-right ml-1"></i>
            </Button>
          </div>
        ))}
      </div>
